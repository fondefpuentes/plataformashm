...
def actualizar_estados():
    ...
    importado()
    # Se tiene que cambiar para tener mas ordenado desde puente a sensor.
    # Obtener datos de puedes con sensores instalados.
    # Obtener las estructuras del puente.
    # Obtener sensores instalados del puente.
    with app.app_context():
        sensores_instalados = SensorInstalado.query.all()
        # Aplicar modelo por hora
